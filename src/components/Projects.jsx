      ...
      <div className="shell">
        ...
        <div className="work">
          ...
          <article className="proj rv">
            <a className="proj-art" href="https://www.npmjs.com/package/@rahulchoudhary05/durabolt" target="_blank" rel="noopener" data-cur="open" aria-label="durabolt on npm"><span className="win"><span className="win-bar"><i></i><i></i><i></i><b>npmjs.com</b></span><span className="win-shot"><span className="shade" aria-hidden="true"></span><img src={projects[0].image} width={1600} height={1000} loading="eager" decoding="async" alt="durabolt open-source Node.js library by Rahul Choudhary" style={{background:'#111',padding:'12%'}} /></span></span><span className="proj-hint" aria-hidden="true">hover · colour</span></a>
            <div className="proj-body">
              ...
              <p className="proj-links">
                <a className="lnk" href="https://www.npmjs.com/package/@rahulchoudhary05/durabolt" target="_blank" rel="noopener">View on npm <svg viewBox="0 0 24 24"><path d="M7 17 17 7M9 7h8v8"/></svg></a>
                <a className="lnk" href="https://github.com/RahulChoudhary05/durabolt" target="_blank" rel="noopener">Source <svg viewBox="0 0 24 24"><path d="M7 17 17 7M9 7h8v8"/></svg></a>
              </p>
            </div>
          </article>

          <article className="proj rv">
            <a className="proj-art" href="https://ciphersqlschool.vercel.app/" target="_blank" rel="noopener" data-cur="open" aria-label="CipherSQL Studio live demo"><span className="win"><span className="win-bar"><i></i><i></i><i></i><b>ciphersqlschool.vercel.app</b></span><span className="win-shot"><span className="shade" aria-hidden="true"></span><img src={projects[1].image} width={1400} height={788} loading="lazy" decoding="async" alt="CipherSQL Studio, an interactive SQL learning platform built by Rahul Choudhary" /></span></span><span className="proj-hint" aria-hidden="true">hover · colour</span></a>
            <div className="proj-body">
              ...
              <p className="proj-links">
                <a className="lnk" href="https://ciphersqlschool.vercel.app/" target="_blank" rel="noopener">Live demo <svg viewBox="0 0 24 24"><path d="M7 17 17 7M9 7h8v8"/></svg></a>
                <a className="lnk" href="https://github.com/RahulChoudhary05/CipherSchools" target="_blank" rel="noopener">Source <svg viewBox="0 0 24 24"><path d="M7 17 17 7M9 7h8v8"/></svg></a>
              </p>
            </div>
          </article>

          <article className="proj rv">
            <a className="proj-art" href="https://medoshieldai.vercel.app/" target="_blank" rel="noopener" data-cur="open" aria-label="MEDO Shield AI live demo"><span className="win"><span className="win-bar"><i></i><i></i><i></i><b>medoshieldai.vercel.app</b></span><span className="win-shot"><span className="shade" aria-hidden="true"></span><img src={projects[2].image} width={1400} height={788} loading="lazy" decoding="async" alt="MEDO Shield AI telemedicine platform with doctor and patient portals, built by Rahul Choudhary" /></span></span><span className="proj-hint" aria-hidden="true">hover · colour</span></a>
            <div className="proj-body">
              ...
              <p className="proj-links">
                <a className="lnk" href="https://medoshieldai.vercel.app/" target="_blank" rel="noopener">Live demo <svg viewBox="0 0 24 24"><path d="M7 17 17 7M9 7h8v8"/></svg></a>
                <a className="lnk" href="https://github.com/RahulChoudhary05/MEDO_SHIELD_AI" target="_blank" rel="noopener">Source <svg viewBox="0 0 24 24"><path d="M7 17 17 7M9 7h8v8"/></svg></a>
              </p>
            </div>
          </article>

          <article className="proj rv">
            <a className="proj-art" href="https://combofinder.vercel.app/" target="_blank" rel="noopener" data-cur="open" aria-label="ComboFinder live demo"><span className="win"><span className="win-bar"><i></i><i></i><i></i><b>combofinder.vercel.app</b></span><span className="win-shot"><span className="shade" aria-hidden="true"></span><img src={projects[3].image} width={1400} height={600} loading="lazy" decoding="async" alt="ComboFinder data file processing tool built with React and Node.js by Rahul Choudhary" /></span></span><span className="proj-hint" aria-hidden="true">hover · colour</span></a>
            <div className="proj-body">
              ...
              <p className="proj-links">
                <a className="lnk" href="https://combofinder.vercel.app/" target="_blank" rel="noopener">Live demo <svg viewBox="0 0 24 24"><path d="M7 17 17 7M9 7h8v8"/></svg></a>
                <a className="lnk" href="https://github.com/RahulChoudhary05/ComboFinder" target="_blank" rel="noopener">Source <svg viewBox="0 0 24 24"><path d="M7 17 17 7M9 7h8v8"/></svg></a>
              </p>
            </div>
          </article>

          <article className="proj rv">
            <a className="proj-art" href="https://srajinfra.vercel.app/" target="_blank" rel="noopener" data-cur="open" aria-label="S Raj Infra Projects live site"><span className="win"><span className="win-bar"><i></i><i></i><i></i><b>srajinfra.vercel.app</b></span><span className="win-shot"><span className="shade" aria-hidden="true"></span><img src={projects[4].image} width={1400} height={788} loading="lazy" decoding="async" alt="S Raj Infra Projects enterprise SaaS platform built by Rahul Choudhary" /></span></span><span className="proj-hint" aria-hidden="true">hover · colour</span></a>
            <div className="proj-body">
          ...
          <article className="proj rv">
            ...
            <div className="proj-body">
              ...
              <p className="proj-links">
                <a className="lnk" href="https://github.com/RahulChoudhary05/BharatMarket-EcommerceWebsite" target="_blank" rel="noopener">Source <svg viewBox="0 0 24 24"><path d="M7 17 17 7M9 7h8v8"/></svg></a>
              </p>
            </div>
          </article>

          <article className="proj rv">
            <a className="proj-art" href="https://www.rktechs.co/" target="_blank" rel="noopener" data-cur="open" aria-label="R K Technical Support live site"><span className="win"><span className="win-bar"><i></i><i></i><i></i><b>rktechs.co</b></span><span className="win-shot"><span className="shade" aria-hidden="true"></span><img src={projects[6].image} width={1400} height={884} loading="lazy" decoding="async" alt="R K Technical Support healthcare clinic website built by Rahul Choudhary" /></span></span><span className="proj-hint" aria-hidden="true">hover · colour</span></a>
            <div className="proj-body">
              ...
              <p className="proj-links">
                <a className="lnk" href="https://www.rktechs.co/" target="_blank" rel="noopener">Live site <svg viewBox="0 0 24 24"><path d="M7 17 17 7M9 7h8v8"/></svg></a>
                <a className="lnk" href="https://github.com/RahulChoudhary05/RKTECHNICALSUPPORT" target="_blank" rel="noopener">Source <svg viewBox="0 0 24 24"><path d="M7 17 17 7M9 7h8v8"/></svg></a>
              </p>
            </div>
          </article>
